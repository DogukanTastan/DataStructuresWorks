...
class Account {
	...
	/** Objects of the message type are stored here, but to avoid confusion, they are divided into incoming and outgoing messages.*/
	 private ArrayList<Message> incoming_messages = new ArrayList<Message>();
	/** Objects of the message type are stored here, but to avoid confusion, they are divided into incoming and outgoing messages.*/
	 private ArrayList<Message> outgoing_messages = new ArrayList<Message>();
	...
	/** Objects of blocked users are kept here.  */
	 protected ArrayList<Account> blockedUsers = new ArrayList<Account>();
	...
	public void login(ArrayList<Account> allAccounts) {
		boolean flag=false;
	...
	public void setBlockedUsers(ArrayList<Account> blockedUsers) {
	...
	public  ArrayList<Message> getOutgoing_messages() {
		return outgoing_messages;
	}
	public void setOutgoing_messages( ArrayList<Message> outgoing_messages) {
		this.outgoing_messages = outgoing_messages;
	}
	public ArrayList<Message> getIncoming_messages() {
		return incoming_messages;
	}
	public void setIncoming_messages(ArrayList<Message> incoming_messages) {
