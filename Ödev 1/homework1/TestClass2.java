...
/**
* This class was made to perform test case 2
...
public class TestClass2 {
	...
	public static void main(String[] args) {
		...
		Account[] AllAccounts=new Account[3];
		...
		AllAccounts[0]=gizemsungu;
		AllAccounts[1]=sibelgulmez;
		AllAccounts[2]=gokhankaya;
		...
		Like like3 = new Like(sibelgulmez);
		post1.addLike(like3);
		sibelgulmez.logout();
		gokhankaya.login(AllAccounts);
		gokhankaya.viewProfile(gizemsungu);
		Comment comment2 = new Comment(gokhankaya,"Nice!");
